...
//Fragment with "in progress" cards list
public class InProgressCardsFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new CardsAdapter(application.inProgressCards));
    }
}