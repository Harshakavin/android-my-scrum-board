...
//Fragment with "testing" cards fragment
public class TestingCardsFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new CardsAdapter(application.testingCards));
    }
